...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/VenkateshAluri/AKGitViewControllers'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'VenkateshAluri' => 'valuri@eitellc.com' }
  s.source           = { :git => 'https://github.com/VenkateshAluri/AKGitViewControllers.git', :tag => s.version.to_s }
